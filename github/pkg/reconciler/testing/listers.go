...
func (l *Listers) GetGithubsourceLister() githublisters.GitHubSourceLister {
	return githublisters.NewGitHubSourceLister(l.indexerFor(&githubsourcev1alpha1.GitHubSource{}))
}
